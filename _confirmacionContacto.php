...
<body>
    ...
    <!-- Contenedor en el que se le confirma al usuario su registro y lo redirecciona a la página de Login -->
    <!-- Page Content -->
    ...
    <div class="container  centrar-texto">
        ...
        <img class="img-fluid rounded mb-4" src="./fotos/gracias.png" alt="">
            <div class="card h-100 ">
                <div class="card-body">
                    <h4 class="card-title letra">Tu mensaje ha sido enviado correctamente</h4>
                    <p class="card-text"> <?php echo "Muchas gracias. Le confirmamos que su mensaje ha sido enviado correctamente. Le responderemos a la mayor brevedad posible. Le estamos redirigiendo a la página de inicio." ; echo '<meta http-equiv="refresh" content="6; url=index.php">'; ?></p>
                </div>
            </div>
    </div>
