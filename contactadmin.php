...
<body>
      ...
      <span class="navbar-toggler-icon"></span>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link letra active" href="contactadmin.php">Contacto</a>
                    </li>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Contacto con Akara<h1>
            <h1><small>No dudes en trasladarme cualquier inquietud</small>
        </h1>
