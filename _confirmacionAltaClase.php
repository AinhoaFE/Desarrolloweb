    ...
    <div class="container  centrar-texto">
        ...
        <img class="img-fluid rounded mb-4" src="./fotos/gracias.png" alt="">
            <div class="card h-100 ">
                <div class="card-body">
                    <h4 class="card-title letra">Confirmación de registro de clase</h4>
                    <p class="card-text"> <?php echo "Muchas gracias " .$nombreUsuario .". Le confirmamos que el registro se ha realizado correctamente." ; echo '<meta http-equiv="refresh" content="10; url=indexadmin.php">'; ?></p>
                </div>
            </div>
