...
<body>
    ...
    <div class="container  centrar-texto">
        ...
        <h1 class="mt-4 mb-3"><small>No autorizado</small></h1>
        <!-- Image Header -->
        <img class="img-fluid rounded mb-4" src="./fotos/restringido.png" alt="">
            <div class="card h-100 ">
                <div class="card-body">
                    <p class="card-text">   <?php

          
echo "<h3>Acceso restringido a miembros de Akarayoga". "</h3>";
echo "<p>Le estamos redirigiendo a la página de login para que pueda iniciar sesión o registrarse". "</p>";
